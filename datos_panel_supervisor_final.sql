-- SCRIPT ÚNICO - DATOS DE PRUEBA PANEL SUPERVISOR
-- Ejecutar este script después de tener las columnas ROL, DEPARTAMENTO, etc.
...
(7, 'Presión Alta', 'Presión 165/108 mmHg - REQUIERE ATENCIÓN MÉDICA INMEDIATA', 'Crítica', '2025-01-26 07:35:00', false),
(7, 'Taquicardia', 'Frecuencia cardíaca 115 bpm - Posible taquicardia', 'Crítica', '2025-01-26 07:35:00', false),
(7, 'Insomnio Severo', 'Solo 2.8 horas de sueño - Impacto crítico en salud', 'Alta', '2025-01-26 07:35:00', false),
-- Alertas moderadas para Matias
(8, 'Presión Elevándose', 'Presión 145/97 mmHg - Monitorear tendencia', 'Media', '2025-01-26 09:05:00', false),
(8, 'Estrés Alto', 'Nivel de estrés 7/10 - Considerar intervención', 'Media', '2025-01-26 09:05:00', false),
-- Alertas para Carlos (jefe)
(6, 'Estrés Ejecutivo', 'Estrés 9/10 - Afecta liderazgo del equipo', 'Media', '2025-01-26 10:05:00', false),
(6, 'Sueño Insuficiente', 'Solo 4.2 horas - Impacta decisiones gerenciales', 'Media', '2025-01-26 10:05:00', false),
-- Alertas positivas para Iahn
(9, 'Empleado Modelo', '¡Métricas de salud perfectas! Ejemplo para el equipo', 'Baja', '2025-01-26 07:45:00', true),
(9, 'Meta Superada', 'Superó meta de pasos: 12,100 pasos', 'Baja', '2025-01-26 07:45:00', true);

-- Verificar datos insertados
SELECT 
    u."NOMBRE" || ' ' || u."APELLIDO" as trabajador,
    u."DEPARTAMENTO",
    COUNT(dv."ID") as datos_vitales,
